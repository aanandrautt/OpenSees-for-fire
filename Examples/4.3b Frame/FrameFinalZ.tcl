...
uniaxialMaterial DamagePlasticityConcreteECT 618 -30300 -0.0025 -15 -0.02 0.5 2900 2.72727e+06
uniaxialMaterial DamagePlasticityConcreteECT 658 -30300 -0.0025 -15 -0.02 0.5 2900 2.72727e+06
uniaxialMaterial DamagePlasticityConcreteECT 678 -40300 -0.0025 -15 -0.02 0.5 2900 2.72727e+06
uniaxialMaterial DPMsteelEC 668 351000 1.91e+08 0.15 0 1 0 1
...
uniaxialMaterial DPMsteelEC 667 408000 1.88e+08 0.15 0 1 0 1

section fiberSecThermal 670 -GJ 1e10  {

# patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
patch rect 658      16     24  -0.100000  -0.125000   0.1000   0.125000
...
# patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
patch rect 678      16     24  -0.100000  -0.125000   0.1000   0.125000
...
pattern Plain 100 Linear {
    load     38        0    -33.9        0        0        0        0
    load     62        0    -33.9        0        0        0        0
}
...
pattern Plain 200 Linear {
	...
	eleLoad -ele    1   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    2   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    3   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    4   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    ...
    eleLoad -ele    16   -type -beamThermal -z   -source  "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    17   -type -beamThermal -z   -source  "ColumnRC1.dat"  -genInterpolation     -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    52  -type -beamThermal -z   -source    "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    53  -type -beamThermal -z   -source    "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20
	...
	eleLoad -ele    65   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    66   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20  
	eleLoad -ele    67   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20
    eleLoad -ele    68   -type -beamThermal -z   -source   "ColumnRC1.dat"  -genInterpolation    -0.125      0.125     -0.125      0.125       20      20 
}
# recording the initial status
