...
This repository also contains the examples given in the paper. To run these examples directly from OpenSees.exe :- Download the .exe file of OpenSees from : https://github.com/aanandrautt/OpenSees-for-fire/releases and save it in the same folder where example script (.tcl file) and thermal load file (.dat file) is saved.
