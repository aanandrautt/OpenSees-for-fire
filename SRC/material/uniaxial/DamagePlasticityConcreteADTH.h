...
#ifndef DamagePlasticityConcreteADTH_h
#define DamagePlasticityConcreteADTH_h

#include <UniaxialMaterial.h>

class DamagePlasticityConcreteADTH : public UniaxialMaterial
{
public:
    DamagePlasticityConcreteADTH(int tag, double _fc, double _epsc0, double _fcu,
        double _epscu, double _rat, double _ft, double _Ets);

    DamagePlasticityConcreteADTH(void);

    virtual ~DamagePlasticityConcreteADTH();

    const char* getClassType(void) const { return "DamagePlasticityConcreteADTH"; };
    ...
    double getCurrentTime(void); //Added by Anand Kumar IITJ
...
private:
   ...
   // double epsLitsp; // AK add for transient strain
    ...
    double epscreep;   // AK added to keep track of creep strain.
    double Eps_creep;    // AK added to keep track of creep strain.
    double Eps_creepP;
};
