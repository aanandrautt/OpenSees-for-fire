...
#ifndef DamagePlasticityConcreteASCE_h
#define DamagePlasticityConcreteASCE_h

#include <UniaxialMaterial.h>

class DamagePlasticityConcreteASCE : public UniaxialMaterial
{
public:
    DamagePlasticityConcreteASCE(int tag, double _fc, double _epsc0, double _fcu,
        double _epscu, double _rat, double _ft, double _Ets);

    DamagePlasticityConcreteASCE(void);

    virtual ~DamagePlasticityConcreteASCE();

    const char* getClassType(void) const { return "DamagePlasticityConcreteASCE"; };
