...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/ElasticMaterialThermal2.h,v $
...
// ElasticMaterialThermal2. ElasticMaterialThermal2 provides the abstraction
...
class ElasticMaterialThermal2 : public UniaxialMaterial
{
  public:
    ElasticMaterialThermal2(int tag, double Epos, double alpha =0.0, double et=0.0, double Eneg=0.0, int softindex = 0);
    ElasticMaterialThermal2();
    ~ElasticMaterialThermal2();

    const char *getClassType(void) const {return "ElasticMaterialThermal2";};
